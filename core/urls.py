...
from core.views.admin import admin_dashboard, update_tutor_languages, update_user_languages, delete_user, update_user_points, grant_initial_points_all, process_withdrawal, grant_gold, revoke_gold, session_create, session_edit, session_delete, toggle_user_star
from core.views.profile import profile, purchase_points, request_withdrawal, transfer_points, request_gold, update_display_name
...
urlpatterns = [
    ...
    # Gold メンバーシップ
    path('profile/display-name/', update_display_name, name='update_display_name'),
    ...
    path('admin-dashboard/user/<int:user_id>/revoke-gold/', revoke_gold, name='revoke_gold'),

    path('admin-dashboard/user/<int:user_id>/star/', toggle_user_star, name='toggle_user_star'),
